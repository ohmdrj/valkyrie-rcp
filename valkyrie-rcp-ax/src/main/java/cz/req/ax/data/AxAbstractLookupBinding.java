...
public abstract class AxAbstractLookupBinding extends CustomBinding {
    ...
    public AxAbstractLookupBinding(AxEditorWidget dataEditor, FormModel formModel, String formPropertyPath) {
    ...
    protected JComponent doBindControl() {
        ...
        JPanel editor = new PanelWithValidationComponent(layout) {
            ...
            public synchronized void addVetoableChangeListener(VetoableChangeListener listener) {
                AxAbstractLookupBinding.this.propertyChangeMonitor.addVetoableChangeListener(listener);
            }
    ...
    protected TabKeyListener createKeyListener() {
        return new TabKeyListener() {
            ...
            public void onTabKey(Component component) {
                ...
                Object ref = AxAbstractLookupBinding.this.getValue();
                ...
                if (evaluateFocusLost(e)) {
                    ...
                    if (revertValueOnFocusLost()) {
                        if (empty) {
                            ...
                            valueModelChanged(AxAbstractLookupBinding.super.getValue());
                        }
    ...
    protected ActionCommand createDataEditorCommand() {
        ActionCommand selectDialogCommand = new ActionCommand(getSelectDialogCommandId()) {
            ...
            protected void doExecuteCommand() {
                if (AxAbstractLookupBinding.this.propertyChangeMonitor.proceedOnChange()) {
                        ...
                        dataEditorDialog = new TitledWidgetApplicationDialog(getDataEditor(),
                            ...
                            protected boolean onFinish() {
                                if (getDataEditor().canClose()) {
                                    return AxAbstractLookupBinding.this.onFinish();
                                }
                                return false;
                            }
